namespace mynfo.Views
{
    ...
    public partial class ProfilesByWebPage : ContentPage
    {
        #region Constructor
        public ProfilesByWebPage()
        {
            InitializeComponent();
        ...
        void OnListViewItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            var mainViewModel = MainViewModel.GetInstance();
            mainViewModel.EditProfileWeb = new EditProfileWebViewModel(tappedItem.ProfileMSId);
